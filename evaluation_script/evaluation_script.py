...
def evaluate(test_annotation_file: str, user_submission_file: str, phase_codename: str = 'Multispectral'):
    ...
    metrics['MR_-2_iou50_all'] = MR_all[0] * 100
    # metrics['MR_-2_iou60_all'] = MR_all[1] * 100
    # metrics['MR_-2_iou75_all'] = MR_all[2] * 100
    ...
    metrics['MR_-2_iou50_day'] = MR_day[0] * 100
    # metrics['MR_-2_iou60_day'] = MR_day[1] * 100
    # metrics['MR_-2_iou75_day'] = MR_day[2] * 100
    ...
    metrics['MR_-2_iou50_night'] = MR_night[0] * 100
    # metrics['MR_-2_iou60_night'] = MR_night[1] * 100
    # metrics['MR_-2_iou75_night'] = MR_night[2] * 100
